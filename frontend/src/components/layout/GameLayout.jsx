...
export default function GameLayout() {
  return (
    <div className="min-h-screen w-screen bg-[#080b12] text-slate-100 flex flex-col overflow-hidden relative selection:bg-cyan-500/30 selection:text-cyan-200">
      <SkipToContent targetId="main-content" />

      {/* Background CRT scanlines effect */}
      <div className="fixed inset-0 scanlines-overlay opacity-25 pointer-events-none z-30" />

      {/* Subtle perimeter warning ambient glow */}
      <div className="fixed inset-0 border border-cyan-950/40 pointer-events-none z-30" />
